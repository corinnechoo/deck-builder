...
def add_card(apps, schema_editor):
    ...
    for data in data_list:
        ...
        if None not in (dbfid, name, playerclass):
            card = CardDetails(dbfid, name, playerclass, armor, artist, attack, cardid, cardset, collectible, cost,
                               durability, elite, faction, flavor, health, img, imggold, locale, mechanics, race, rarity, cardtype)
            card.save()
